    ...
    <footer id="kontakt" className="border-t border-white/10 bg-anthracite-900">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/50">
              <li className="flex items-start gap-3">
                ...
                Musterstraße 12, 53111 Bonn
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 shrink-0 text-accent-light" />
                <a href="tel:+4900000000" className="hover:text-white">
                  0228 / 000 00 00
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 shrink-0 text-accent-light" />
                <a href="mailto:info@fkd-fahrzeuge.de" className="hover:text-white">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-xs text-white/40 sm:flex-row">
          <p>© {new Date().getFullYear()} FKD Fahrzeuge. Alle Rechte vorbehalten.</p>
